...
public class AccntActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!textRecognizer.isOperational()) {
            ...
            Log.w("AccntActivity", "Dependencies are not yet available...Please try again later");
        } else {
                ...
                public void surfaceCreated(SurfaceHolder holder) {
                    ...
                    try {
                        ...
                        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                            ...
                            ActivityCompat.requestPermissions(AccntActivity.this,
    ...
    private void signout()
    {
        ...
        try {
            ...
            startActivity(new Intent(AccntActivity.this, MainActivity.class));
        }
